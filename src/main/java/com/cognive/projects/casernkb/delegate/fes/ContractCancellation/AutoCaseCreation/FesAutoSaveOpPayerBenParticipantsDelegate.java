...
public class FesAutoSaveOpPayerBenParticipantsDelegate implements JavaDelegate {
    ...
    public void execute(DelegateExecution execution) throws Exception {
        ...
        Client client = fesService.getOtherPersonClientFromList(payment.getOtherPersonsList(), "17");
        if (client != null) {
            FesParticipant fesParticipant = fesService.saveFesParticipantOp(fesCategory, client, "7");
