...
public interface MinioService {
    ...
    String putObject(MultipartFile multipartFile, String bucketName, String folderName, String fileType);
    String putObject(InputStream file, String bucketName, String folderName, String objectName, String fileType);

    /** *  File stream download  * @param bucketName * @param objectName * @return */
    InputStream downloadObject(String bucketName, String folderName ,String objectName);
