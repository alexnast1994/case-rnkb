...
rjAggregate.transferToKo = profAggGeneral == null || profAggGeneral.isEmpty() || !profAggGeneral.any {it -> it.profAgr72 != null} ? 0 : profAggGeneral.findAll {it -> it.profAgr72 != null}.collect().sum { p -> p.profAgr72 } as BigDecimal
