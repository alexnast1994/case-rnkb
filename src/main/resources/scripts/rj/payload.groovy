...
def caseElements = (typeRj == "1" || typeRj == "2") && payloadObject.hasProp("caseIds") && payloadObject.prop("caseIds") != null && payloadObject.prop("caseIds").elements().size() > 0 ? payloadObject.prop("caseIds").elements() : null
