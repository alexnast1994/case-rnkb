...
@Deployment(resources = {
        "bpmn/judgment/amlAutoReasonedJudgmentWithoutCases.bpmn"
})
public class AmlAutoReasonedJudgmentWithoutCasesTest {

    @Rule
    public ProcessEngineRule processEngineRule = new ProcessEngineRule();

    private String getPayloadJson(Long caseId, Long clientId) {
        return "{\"payload\":{\"amlAutoReasonedJudgment\":{\"clientId\":" + clientId + ",\"startDate\": \"2022-06-02T00:00:00\"," +
                "\"offDate\": \"2022-06-03T00:00:00\",\"typeRj\": \"3\"}}}";
    }

    @Test
    public void Should_work() {
        autoMock("bpmn/judgment/amlAutoReasonedJudgmentWithoutCases.bpmn");
        ...
        ProcessInstance processInstance = runtimeService.startProcessInstanceByKey("amlAutoReasonedJudgmentWithoutCases", processParams);
